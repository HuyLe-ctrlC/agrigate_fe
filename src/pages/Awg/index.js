...
import { selectAwg, getAllAction, addDataAction, getByIdAction, updateDataAction } from '../../redux/slices/awgSlices';
...
export const Awg = () => {
    const title = 'Quản lý tăng trọng trung bình';
    ...
    const { data, totalPage, loading, appError, msgSuccess } = awgData;
