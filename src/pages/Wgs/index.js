...
import { getAllAction, addDataAction, getByIdAction, updateDataAction, selectWgs } from '../../redux/slices/wgsSlices';
import * as cowBreedsSlice from '../../redux/slices/cowBreedsSlice';
import * as weightP0Slices from '../../redux/slices/weightP0Slices';
...
export const Wgs = () => {
    ...
    const getData = () => {
        ...
        dispatch(cowBreedsSlice.getAllAction());
        dispatch(weightP0Slices.getAllAction());
    };
    ...
    const cowBreedData = useSelector(cowBreedsSlice.selectCowBreeds);
    const weightP0Data = useSelector(weightP0Slices.selectWeightP0);
    const { data, totalPage, loading, appError, msgSuccess } = wgsData;
        ...
        if (formStatusState) {
            return (
                <Form
                    ...
                    cowBreedData={cowBreedData.data}
                    weightP0Data={weightP0Data.data}
                />
            );
        }
    };
                    ...
                    <div className="card-body">
                        <div className="top_tools d-flex mb-3">
                            <Search
                                ...
                                dataCowBreed={cowBreedData.data}
                                dataWeightP0={weightP0Data.data}
                            />
