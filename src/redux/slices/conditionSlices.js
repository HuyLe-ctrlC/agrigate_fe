...
export const getAllAction = createAsyncThunk(
    ...
    async (params, { rejectWithValue, getState, dispatch }) => {
        try {
            // call Api
            const response = await conditionApi.getAll(params);
...
export const getByIdAction = createAsyncThunk(
    ...
    async (id, { rejectWithValue, getState, dispatch }) => {
        try {
            // call Api
            const response = await conditionApi.getById(id);
...
export const statusPublishAction = createAsyncThunk(
    ...
    async (dataUpdate, { rejectWithValue, getState, dispatch }) => {
        ...
        try {
            ...
            const response = await conditionApi.status(id, body);
            if (response.result) {
                const results = {
                    msg: response.data[0].msg,
                    publish: publish,
...
export const sortAction = createAsyncThunk(
    ...
    async (dataUpdate, { rejectWithValue, getState, dispatch }) => {
        ...
        try {
            ...
            const body = JSON.stringify(data);
            const response = await conditionApi.sort(id, body);
            if (response.result) {
                const results = {
                    msg: response.data[0].msg,
                };
...
export const selectCondition = (state) => state?.condition;

export default conditionSlices.reducer;
